...
//  Future<Null> _selectDateAc(BuildContext context) async {
//    final DateTime pickedAc = await showDatePicker(
//        context: context,
//        //locale: Locale("pt"),
//        initialDate: selectedDateAc,
//        firstDate: DateTime(2000, 8),
//        lastDate: DateTime(2101));
//    if (pickedAc != null && pickedAc != selectedDateAc)
//      setState(() {
//        dataSelecionadaAc = true;
//        fraseSelecaoAc = false;
//        selectedDateAc = pickedAc;
...
//                                              decoration: _dropdownError != null? new BoxDecoration(
//                                                  border: new Border(
//                                                    bottom: BorderSide(color: Colors.red[300], width: double.infinity),
//                                                      ),)
//                                                  : new BoxDecoration(
...
//                                             child: Divider(color: Colors.red[800],
//                                               height: 0, thickness: 1.1,),
//                                           ),
//                                          ],
//                                        ),
//                                      ),
...
//                                                      )),
//                                                  Visibility(
//                                                    visible: dataSelecionadaAc,
//                                                    child: Text(
//                                                      "${DateFormat('EEEE, dd/MM/yyyy', "pt").format(selectedDateAc).toString()}"
//                                                      //"${selectedDate.toLocal()}"
//                                                      //.split(' ')[0]
//                                                      ,
//                                                      style: GoogleFonts.roboto(
