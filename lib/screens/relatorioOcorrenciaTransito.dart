...
import 'package:ett_app/widgets/calendario.dart';
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Flexible(
                        child:
                            TextRow('Análise de Monitoramento', Colors.black87),
                      ),
                    ],
                  ),
                  SizedBox(height: 20),
                            ...
                            children: <Widget>[
                              Flexible(
                                child: InputFormWithDecoration(
                                  ...
                                  _monitorKey,
                                  _monitorController,
                                  composeValidators('monitor',
                                      [requiredValidator, stringValidator]),
                                  (value) => _loginData.monitor = value,
                                  true,
                                ),
                              ),
                            ],
...
//Nome
                          ...
                          Calendario(_selectDate, dataSelecionada, fraseSelecao,
                              linhaVisivel, semData, selectedDate),
                              ...
                              Flexible(
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: composeValidators('placa', [
                                      requiredValidator,
                                      placaValidator,
                                      minLegthValidator
                                    ]),
