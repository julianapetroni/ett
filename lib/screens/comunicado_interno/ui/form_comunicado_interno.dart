      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            validator:
                composeValidators('a data', [requiredValidator, dataValidator]),
            onSaved: (value) => _loginData.foraDeServico = value,
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            validator: composeValidators(
                'a hora', [requiredValidator, minLengthValidator]),
            onSaved: (value) => _loginData.hora = value,
            decoration: InputDecoration(hintText: ''),
          ),
        ),
        SizedBox(
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            validator: composeValidators('a chapa', [minLengthValidator]),
            onSaved: (value) => _loginData.chapa = value,
            decoration: InputDecoration(hintText: ''),
          ),
        ),
        SizedBox(
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            validator: composeValidators('o nome', [minLengthValidator]),
            onSaved: (value) => _loginData.veiculo = value,
            decoration: InputDecoration(hintText: ''),
          ),
        ),
        SizedBox(
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            validator: composeValidators('o veículo', [minLengthValidator]),
            onSaved: (value) => _loginData.veiculo = value,
            decoration: InputDecoration(hintText: ''),
          ),
        ),
        ...
        Padding(
          ...
          child: TextFormField(
            ...
            validator: composeValidators(
                'o local da ocorrência', [minLengthValidator]),
            onSaved: (value) => _loginData.local = value,
            decoration: InputDecoration(hintText: ''),
          ),
        ),
        SizedBox(
