...
class Draw extends StatefulWidget {
  ...
  Draw({Key key, this.sol, this.user, this.token}) : super(key: key);
                      ...
                      children: <Widget>[
                        GestureDetector(
                          ...
                          child: Draggable(
                            ...
                            onDragEnd: (drag) {
                              setState(() {
                                if ((busTop + drag.offset.dy) >
                                    (300.0 - 30.0)) {
                                  busTop = (300.0 - 30.0);
                                } else if ((busTop + drag.offset.dy - 30.0) <
                                    0.0) {
                                  busTop = 0;
                                } else {
                                ...
                                if ((left + drag.offset.dx) > (300.0 - 30.0)) {
                                  left = (300.0 - 30.0);
                                } else if ((carLeft + drag.offset.dx - 30.0) <
                                    0.0) {
                                  left = 0;
                                } else {
                        ...
                        GestureDetector(
                          ...
                          child: Draggable(
                            child: Container(
                              padding:
                                  EdgeInsets.only(top: carTop, left: carLeft),
                              child: DragCar(),
                            ),
                            feedback: Container(
                              padding:
                            ...
                            onDragEnd: (drag) {
                              setState(() {
                                if ((carTop + drag.offset.dy) >
                                    (300.0 - 30.0)) {
                                  carTop = (300.0 - 30.0);
                                } else if ((carTop + drag.offset.dy - 30.0) <
                                    0.0) {
                                  carTop = 0;
                                } else {
                        ...
                        GestureDetector(
                          ...
                          child: Draggable(
                            child: Container(
                              padding:
                                  EdgeInsets.only(top: bikeTop, left: bikeLeft),
                              child: DragBike(),
                            ),
                            feedback: Container(
                              padding:
                            ...
                            onDragEnd: (drag) {
                              setState(() {
                                if ((bikeTop + drag.offset.dy) >
                                    (300.0 - 30.0)) {
                                  bikeTop = (300.0 - 30.0);
                                } else if ((bikeTop + drag.offset.dy - 30.0) <
                                    0.0) {
                                  bikeTop = 0;
                                } else {
                                ...
                                if ((left + drag.offset.dx) > (300.0 - 30.0)) {
                                  bikeLeft = (300.0 - 30.0);
                                } else if ((bikeLeft + drag.offset.dx - 30.0) <
                                    0.0) {
                                  bikeLeft = 0;
                                } else {
...
//                              ),
                        GestureDetector(
                          ...
                          child: Draggable(
                            ...
                            onDragEnd: (drag) {
                              setState(() {
                                if ((truckTop + drag.offset.dy) >
                                    (300.0 - 30.0)) {
                                  truckTop = (300.0 - 30.0);
                                } else if ((truckTop + drag.offset.dy - 30.0) <
                                    0.0) {
                                  truckTop = 0;
                                } else {
                                ...
                                } else if ((truckLeft + drag.offset.dx - 30.0) <
                                    0.0) {
                                  truckLeft = 0;
                                } else {
                        ...
                        GestureDetector(
                          ...
                          child: Draggable(
                            ...
                            onDragEnd: (drag) {
                              setState(() {
                                if ((pickUpTop + drag.offset.dy) >
                                    (300.0 - 30.0)) {
                                  pickUpTop = (300.0 - 30.0);
                                } else if ((pickUpTop + drag.offset.dy - 30.0) <
                                    0.0) {
                                  pickUpTop = 0;
                                } else {
                                ...
                                if ((left + drag.offset.dx) > (300.0 - 30.0)) {
                                  ...
                                  pickUpLeft =
                                      pickUpLeft + drag.offset.dx - 30.0;
                                }
                              });
                            },
                          ),
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Flexible(
                              ...
                              child: Text(
                                "1. Mova os ícones para posicioná-los de acordo com a cena do acidente;\n\n2. Clique na barra abaixo para escolher as cores e desenhar;\n\n3. Clique no ícone de câmera abaixo para gravar o seu desenho!",
                                style: TextStyle(
                                    fontSize: 15,
