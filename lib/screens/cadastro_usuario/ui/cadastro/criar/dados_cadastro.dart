...
import 'package:ett_app/screens/login/ui/termos_uso.dart';
                      ...
                      if (form.validate()) {
                        ...
                        if (_isChecked == false) {
                          final snackBar = new SnackBar(
                              content: new Text(
                                  'Favor concordar com os Termos de Uso'));
                          _scaffoldKey.currentState.showSnackBar(snackBar);
                        } else if (_passwordController.text !=
                            _confirmPasswordController.text) {
                          final senhasDif = new SnackBar(
                              content: new Text('Senhas Diferentes!'));
                          ...
                          user.complemento =
                              _loginData.complemento; //_loginData.complemento;
                          ...
                          String url =
                              'http://app.cartaopec.com.br/api/cadastros';
                          ...
                          http
                            ...
                            if (_loginData.email != null) {
                              final emailCadastrado = new SnackBar(
                                  content: new Text('Email já cadastrado!'));
                              _scaffoldKey.currentState
                                  .showSnackBar(emailCadastrado);
                            } else {
                              final erroCadastro = new SnackBar(
                                  content:
                                      new Text('Verifique os seus dados!'));
                              _scaffoldKey.currentState
