...
//
//  @override
//  DadosCadastroState createState() => new DadosCadastroState(user: user, token: token, sol: sol);
//}
//
...
//    var res = await http.get("http://app.cartaopec.com.br/api/cadastros/cidades/status/ATIVO");
//    print(res.body);
//    return res.body;
//  }
...
//    var res = await http.get('http://app.cartaopec.com.br/api/cadastros/estados/status/ATIVO');
//    print(res.body);
//    return res.body;
//  }
...
//                                            [requiredValidator, cpfValidator, maxLegthCPFValidator]),
...
//                                          context,
//                                          MaterialPageRoute(
//                                              builder: (context) => TermosDeUso(user: user, token: token, sol: sol)),
//                                        );
//                                      });
//                                    },
//                                    child: Container(
